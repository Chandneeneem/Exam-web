...
const InsertQuestions = () => {
    ...
    const addQuestion = async () => {
        if (!formData.question || formData.options.some(option => option === '') || !formData.correctAnswer || !formData.timeLimit) {
            toast.error('Please fill all fields.');
            return;
        }
        try {
            await axios.post('http://localhost:5000/questionData', formData);
                    ...
                    <Card.Body>
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="timeLimit" className="mb-3">
                                ...
                                <Form.Control type="number" name="timeLimit" value={formData.timeLimit} onChange={handleChange} placeholder="Enter time limit" />
                            </Form.Group>
